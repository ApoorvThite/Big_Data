...
ratings_DF = ss.read.csv("/storage/home/aat5564/work/Lab5/ratings_large.csv", schema= rating_schema, header=False, inferSchema=False)
...
movies_DF = ss.read.csv("/storage/home/aat5564/work/Lab5/movies_large.csv", schema=movie_schema, header=False, inferSchema=False)
...
genre_count_rdd.saveAsTextFile("/storage/home/aat5564/work/Lab5/Genre_count_cluster.txt")
...
from pyspark.sql.functions import array_contains
SelectGenreAvgRating_DF = joined_DF.filter(array_contains('Genres_Array',                                                'Comedy')).select("MovieID","AvgRating","count","MovieTitle","Genres","Genres_Array")
...
output_path = "/storage/home/aat5564/work/Lab5/TopMovies4YourGenre_cluster"
